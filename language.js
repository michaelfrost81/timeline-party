(() => {
  ...
  document.addEventListener("click",e=>{const b=e.target.closest("#language-switcher [data-lang]");if(!b)return;lang=b.dataset.lang;localStorage.setItem(KEY,lang);if(lang==="da-DK")location.reload();else apply();},true);
